...
best4_test_cases = [  
    Best4TestCase(
        description="Test Case 1: Best4LinReg - Seed {}".format(seed),
        group="best4lr",
        max_tests=15,
        needed_wins=10,
        row_limits=(10, 1000),
        col_limits=(2, 10),
        seed=seed,
    ) for seed in [1489683274, 90210, 123456789, 42, 8675309]
] + [
    Best4TestCase(
        description="Test Case 2: Best4DT - Seed {}".format(seed),
        group="best4dt",
        max_tests=15,
        needed_wins=10,
        row_limits=(10, 1000),
        col_limits=(2, 10),
        seed=seed,
    ) for seed in [1489683274, 112358, 314159, 271828, 161803]
] + [
    Best4TestCase(
